...
module VexRiscv (
  ...
  assign _zz__zz_decode_PREDICTION_CONTEXT_hazard_4_1 = (IBusSimplePlugin_iBusRsp_stages_0_input_payload >>> 2'd2);
  ...
  assign _zz_decode_PREDICTION_CONTEXT_line_history = (IBusSimplePlugin_fetchPc_output_payload >>> 2'd2);
  assign _zz_decode_PREDICTION_CONTEXT_line_history_1 = (IBusSimplePlugin_iBusRsp_stages_0_output_ready || IBusSimplePlugin_externalFlush);
  assign _zz_decode_PREDICTION_CONTEXT_hazard_5 = (IBusSimplePlugin_decodePrediction_rsp_wasWrong ^ memory_PREDICTION_CONTEXT_line_history[1]);
  ...
  always @(*) begin
    IBusSimplePlugin_decodePrediction_cmd_hadBranch = ((decode_BRANCH_CTRL == BranchCtrlEnum_JAL) || ((decode_BRANCH_CTRL == BranchCtrlEnum_B) && decode_PREDICTION_CONTEXT_line_history[1]));
    if(_zz_10) begin
